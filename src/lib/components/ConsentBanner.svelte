	...
	>
		<div style="display: flex; align-items: center; gap: 1.5rem; flex-wrap: wrap;">
			...
			<div style="flex: 1; min-width: 280px;">
				{#if isVersionUpdate}
					<p style="margin: 0 0 0.375rem; color: var(--color-text); font-size: 0.875rem; font-weight: 600;">
				...
				{:else}
					<p style="margin: 0 0 0.375rem; color: var(--color-text); font-size: 0.875rem;">
						{t().consent.message}
						<a href="/privacy" style="margin-left: 0.375rem; color: var(--color-text-muted); font-size: 0.8rem;">{t().consent.bannerPrivacy}</a>
					</p>
				{/if}

				<div style="display: flex; gap: 1.25rem; flex-wrap: wrap;">
					<label style="display: flex; align-items: center; gap: 0.375rem; cursor: pointer; opacity: 0.55;">
					...
					<label style="display: flex; align-items: center; gap: 0.375rem; cursor: pointer;">
						<input type="checkbox" bind:checked={analytics} style="accent-color: var(--color-accent);" />
						<span style="font-size: 0.8rem; color: var(--color-text);">Analytics</span>
					</label>
					<label style="display: flex; align-items: center; gap: 0.375rem; cursor: pointer;">
						<input type="checkbox" bind:checked={advertising} style="accent-color: var(--color-accent);" />
