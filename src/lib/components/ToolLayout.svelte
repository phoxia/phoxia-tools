...
<div class="tool-shell" id="main-content">
	...
	<!-- Overlay for mobile -->
	{#if sidebarState.open}
		<div class="sidebar-overlay" onclick={() => (sidebarState.open = false)} role="presentation"></div>
	{/if}

	<!-- Main tool content -->
	<main class="tool-main">
		<header style="margin-bottom: 1.75rem;">
			<h1 style="font-family: var(--font-heading); font-size: 1.5rem; margin: 0 0 0.25rem; line-height: 1.2;">
				{title}
			</h1>
