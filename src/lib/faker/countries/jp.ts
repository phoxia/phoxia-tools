...
const jp: CountryData = {
	id: 'jp', flag: '🇯🇵',
	firstNames: [
		'Ren','Hinata','Sota','Yui','Haruto','Sakura','Yuto','Riko','Riku','Aoi',
		'Sora','Mei','Yamato','Mio','Taiga','Rin','Haruki','Yuna','Asahi','Miyu',
		'Itsuki','Hana','Shota','Koharu','Kaito','Nanami','Sosuke','Ayaka','Takumi','Rio',
		'Ryo','Yuzuki','Daiki','Kanon','Minato','Moe','Kenta','Miku','Hiroto','Nagi'
	],
	lastNames: [
		...
		'Ogawa','Goto','Okada','Hasegawa','Murakami','Kondo','Ishii','Nishimura','Sakamoto','Endo'
	],
	states: [
	...
	cities: [
		...
		'Hiroshima','Sendai','Chiba','Kitakyushu','Sakai','Niigata','Hamamatsu','Shizuoka','Okayama',
		'Kumamoto','Kagoshima','Matsuyama','Nagasaki','Oita','Kanazawa'
	],
